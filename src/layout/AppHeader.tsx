...
const AppHeader: React.FC<AppHeaderProps> = ({ onShowCMS }) => {
    ...
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-50 dark:border-gray-800 dark:bg-gray-900 border-b shadow-sm app-header">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-2 xl:px-4">
        <div className="flex items-center justify-between w-full gap-1 px-2 py-2 border-b border-gray-200 dark:border-gray-800 sm:gap-2 sm:px-3 sm:py-3 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            className="items-center justify-center w-8 h-8 text-gray-500 border-gray-200 rounded-lg z-99999 dark:border-gray-800 sm:w-10 sm:h-10 lg:flex dark:text-gray-400 lg:h-11 lg:w-11 lg:border"
          ...
          <button
            ...
            className="flex items-center justify-center w-8 h-8 text-gray-700 rounded-lg z-99999 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 sm:w-10 sm:h-10 lg:hidden"
          >
            <svg
              width="24"
              height="24"
        ...
        <div
          ...
          } items-center justify-between w-full gap-2 px-2 py-3 sm:gap-4 sm:px-3 sm:py-4 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none`}
        >
          <div className="flex items-center gap-1 sm:gap-2 2xsm:gap-3">
            {/* <!-- Dark Mode Toggler --> */}
            <ThemeToggleButton />
            {/* <!-- Dark Mode Toggler --> */}
