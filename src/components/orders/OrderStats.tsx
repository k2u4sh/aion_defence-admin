    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 gap-3 sm:gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {statCards.map((stat, index) => (
          <div
            key={index}
            className="relative overflow-hidden rounded-lg bg-white px-3 py-4 shadow dark:bg-gray-800 sm:px-4 sm:py-5 lg:px-6"
          >
      ...
      <div className="bg-white rounded-lg shadow dark:bg-gray-800">
        <div className="px-3 py-4 sm:px-4 sm:py-5 lg:p-6">
          <h3 className="text-base sm:text-lg font-medium leading-6 text-gray-900 dark:text-white mb-3 sm:mb-4">
            Order Status Breakdown
          </h3>
          <div className="grid grid-cols-2 gap-3 sm:gap-4 sm:grid-cols-3 lg:grid-cols-6">
            {statusBreakdown.map((status, index) => (
              <div key={index} className="text-center">
                <div className={`${status.color} w-2 h-2 sm:w-3 sm:h-3 rounded-full mx-auto mb-1 sm:mb-2`}></div>
        ...
        <div className="px-3 py-4 sm:px-4 sm:py-5 lg:p-6">
          ...
          <div className="grid grid-cols-1 gap-3 sm:gap-4 sm:grid-cols-3">
            <div className="text-center">
              ...
              <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Paid Orders</div>
            </div>
            <div className="text-center">
              <div className="text-xl sm:text-2xl font-bold text-yellow-600 dark:text-yellow-400">
                {stats.pendingPayments}
              </div>
              <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Pending Payments</div>
            </div>
            <div className="text-center">
              <div className="text-xl sm:text-2xl font-bold text-blue-600 dark:text-blue-400">
                {formatNumber(stats.totalRevenue)}
              </div>
              <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Total Revenue ($)</div>
            </div>
          </div>
        </div>
      </div>
