...
export default function UserDropdown() {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setCurrentUser({
            ...
            email: data.data.email || "admin@example.com"
          });
        }
      } catch (error) {
  ...
  async function handleLogout() {
    try {
      // Call server to clear HTTP-only session cookie
    ...
    try {
      // Best-effort clear of any non-HTTPOnly cookie set on client
      ...
      <div className="relative">
        ...
        >
          ...
          <span className="block mr-1 font-medium text-theme-sm">
            {isLoading ? "Loading..." : currentUser.firstName}
          </span>
